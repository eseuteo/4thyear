...
%     end
    ...
    % Storage:
    PDetStore = NaN*zeros(1, nSteps);
    PErrStore = NaN*zeros(2,nSteps);% error in position and angle
    FeatDetStore = NaN*zeros(nFeatures,nSteps);
